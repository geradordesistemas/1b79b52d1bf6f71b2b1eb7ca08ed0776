...
./run.sh bin/console security:create-admin adriano test@gmail.com 1b79b52d1bf6f71b2b1eb7ca08ed0776

# Cria usuário padrão
./run.sh bin/console security:create-user adriano test@gmail.com 1b79b52d1bf6f71b2b1eb7ca08ed0776
